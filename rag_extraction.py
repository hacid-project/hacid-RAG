...
if __name__ == '__main__':
    ...
    if using_extractor is None: # w/o extractor mode
        using_prompt = Humandx_entity_extraction_prompt
    ...
    PARAMETERS = {
        ...
        # "input_text_dir": f"data/pubmed_eval_datasets/2023_selected_limit_100.json",
        # "input_text_dir": f"data/mimiciv/eval/notes_concepts.json",
        ...
        "test_id": f"_test_entityextraction_{eval_dataset}_{using_llm}_{using_embed}_topk{similarity_top_k}_depth{graph_store_query_depth}_{retrieve_mode}_extractor_{using_extractor}"
    }
