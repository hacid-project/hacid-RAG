...
if __name__ == "__main__":
    ...
    # using_embed = "minilml6v2" # "hitsnomed"
    using_embed = "bgem3"
    ...
    PARAMETERS = {
        ...
        "index_persist_dir": f"index/snomed_all_dataset_nodoc_{using_llm}_{using_embed}",
        "knowledge_graph_dataset_dir": "data/snomed/snomed_all_dataset.csv",
    }

    logging_setup(log_file=f"logs/KG_RAG_simple_builder_csv_{using_llm}_{using_embed}.log", log_level=logging.INFO)
